...
import 'bluetooth_device_list_page_widget.dart'
    show BluetoothDeviceListPageWidget;
...
class BluetoothDeviceListPageModel
    extends FlutterFlowModel<BluetoothDeviceListPageWidget> {
  ...
  // Stores action output result for [Custom Action - getConnectedDevices] action in BluetoothDeviceListPage widget.
  List<BTDeviceStruct>? fetchConnectedDevices;
  // Stores action output result for [Custom Action - findDevices] action in BluetoothDeviceListPage widget.
  ...
  List<BTDeviceStruct>? fetchConnectedDevicesCopy;
