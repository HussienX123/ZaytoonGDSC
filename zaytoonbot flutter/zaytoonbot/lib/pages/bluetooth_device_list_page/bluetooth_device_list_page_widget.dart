...
import 'bluetooth_device_list_page_model.dart';
export 'bluetooth_device_list_page_model.dart';

class BluetoothDeviceListPageWidget extends StatefulWidget {
  const BluetoothDeviceListPageWidget({
    super.key,
    bool? isBTEnabled,
  ...
  @override
  State<BluetoothDeviceListPageWidget> createState() =>
      _BluetoothDeviceListPageWidgetState();
}

class _BluetoothDeviceListPageWidgetState
    extends State<BluetoothDeviceListPageWidget> with TickerProviderStateMixin {
  late BluetoothDeviceListPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BluetoothDeviceListPageModel());
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      if (_model.isBluetoothEnabled) {
        ...
        _model.fetchConnectedDevices = await actions.getConnectedDevices();
        setState(() {
          _model.isFetchingConnectedDevices = false;
          _model.connectedDevices =
              _model.fetchConnectedDevices!.toList().cast<BTDeviceStruct>();
        });
                  ...
                  Switch.adaptive(
                    ...
                    onChanged: (newValue) async {
                      ...
                      if (newValue!) {
                        ...
                        _model.fetchConnectedDevicesX =
                            await actions.getConnectedDevices();
                        setState(() {
                          _model.isFetchingConnectedDevices = false;
                          _model.connectedDevices = _model
                              .fetchConnectedDevicesX!
                              .toList()
                              .cast<BTDeviceStruct>();
                        });
                        _model.fetchedDevicesX = await actions.findDevices();
                        setState(() {
                          _model.isFetchingDevices = false;
                          _model.foundDevices = _model.fetchedDevicesX!
                              .toList()
                              .cast<BTDeviceStruct>();
                        });
                                                                ...
                                                                Row(
                                                                  ...
                                                                  children: [
                                                                    ...
                                                                    StrengthIndicatorWidget(
                                                                      key: Key(
                                                                          'Keyj21_${displayConnectedDevicesIndex}_of_${displayConnectedDevices.length}'),
                                              ...
                                              if (!_model.isFetchingDevices)
                                                InkWell(
                                                  ...
                                                  onTap: () async {
                                                    ...
                                                    _model.fetchConnectedDevicesCopy =
                                                        await actions
                                                            .getConnectedDevices();
                                                    setState(() {
                                                      _model.isFetchingConnectedDevices =
                                                                ...
                                                                children: [
                                                                  Row(
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      StrengthIndicatorWidget(
                                                                        key: Key(
                                                                            'Keyiob_${displayFoundDevicesIndex}_of_${displayFoundDevices.length}'),
                                                                        rssi: displayFoundDevicesItem
                                                                            .rssi,
                                                                        color: valueOrDefault<
                                                                            Color>(
                                                                          () {
                                                                            if (displayFoundDevicesItem.rssi >=
                                                                                -67) {
                                                                              return FlutterFlowTheme.of(context).success;
                                                                            } else if (displayFoundDevicesItem.rssi >=
                                                                                -90) {
                                                                              return FlutterFlowTheme.of(context).warning;
                                                                            } else {
                                                                              return FlutterFlowTheme.of(context).error;
